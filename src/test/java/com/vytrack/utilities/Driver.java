            ...
            switch (browser) {
                ...
                case "remote_chrome":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL("http://ec2-52-203-84-182.compute-1.amazonaws.com:4444/wd/hub"), chromeOptions));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                case "remote_firefox":
                    try {
                        ...
                        driverPool.set(new RemoteWebDriver(new URL("http://ec2-52-203-84-182.compute-1.amazonaws.com:4444/wd/hub"), desiredCapabilities));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
