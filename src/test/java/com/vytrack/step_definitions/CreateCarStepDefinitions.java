...
public class CreateCarStepDefinitions {
    ...
    public CreateCarStepDefinitions() throws MalformedURLException {
    }

    @Then("user click on {string} button")
    public void user_click_on_button(String string) throws MalformedURLException {
...
//    .get("Model Year") - get value of Model Year
    @Then("user adds new car information:")
    public void user_adds_new_car_information(List<Map<String, String>> dataTable) throws MalformedURLException {
